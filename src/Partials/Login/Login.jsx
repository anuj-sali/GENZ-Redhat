  ...
  //console.log(finalOtp)
   ...
   const handleLogout = () => {
    ...
    document.getElementById("top").style.backgroundColor="#dc3226";
      document.getElementById("top").innerText=`Login/SignUp`
      onClose();
      setVerify(false)
   }
    ...
    return (
      <>
        <Button id="top" onClick={onOpen} style={{backgroundColor:"#dc3226",color:"white", marginLeft:"2\px"}}>Login/SignUp</Button>
  
        
        <Modal closeOnOverlayClick={false} onClose={onClose} isOpen={isOpen} size={{sm:"sm",md: "md",lg: 'lg',xl:"xl",base : "xs"}} isCentered  >
          <ModalOverlay />
          <ModalContent  >
        ...
        prepend={
          <EuiToolTip content="content">
            <EuiText size="m">+91</EuiText>
          </EuiToolTip>
        }
        onChange={(e)=> setPhone(e.target.value)}
        aria-label="Use aria labels when no actual label is in use"
      />
              {/* <Input onChange={(e)=> setPhone(e.target.value)} type="tel" style={{border: "none",textAlign:"left"}} maxLength="10"  variant='flushed' /> */}
              </InputGroup>
      ...
      />
             {/* <InputLeftAddon children='Mr./Mrs.' />  */}
              ...
              <Box style={{width:"50%",marginLeft:"125px"}}>
