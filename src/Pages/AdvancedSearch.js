...
class AdvancedSearch extends React.Component {
    ...
    constructor() {
        super()
        this.state = { search: false,show:false,url:null }
    }
    ...
    render() {
        return (
            ...
            <div className="mx-4 mt-3">
                <EuiPageHeader
                    pageTitle={<span className="fs-2" style={{"marginRight": "20px"}} >Advanced Search:</span>}
                    // pageTitle="Advanced Search"
                    iconType="searchProfilerApp"
                    rightSideItems={[
                        // <EuiButton iconType={'refresh'} size='s' >Reset</EuiButton>,
                        <button type="button" class="btn btn-secondary btn-m">Reset</button>
                    ]}
                    alignItems={'center'}
                />
                </div>
                ...
                <EuiFlexGroup>
                    <EuiFlexItem grow={4}>
                        <EuiPanel>
                            ...
                            <EuiFormRow label="Record Title">
                                <EuiFieldText prepend={"Contains"} />
                            </EuiFormRow>
                            <EuiFormRow label="Threat Actors">
